    ...
    public $phases = [
        ...
        [
            ...
            'technical_details' => [
                ...
                'Shipment API' => 'GET /shipments/{SHIPMENT_ID}/costs - retorna o custo real exato (sender_cost) pago pelo vendedor.',
                'Frete Real' => 'Busca automatizada no endpoint de custos do ML, ignorando estimativas e calculando o desconto de subsídio (gap_discount).',
                'Frete FULL/FLEX' => 'Captura taxa de manuseio e frete subsidiado diretamente do detalhamento de custos do pedido.',
        ...
        [
            ...
            'technical_details' => [
                'CÁLCULO DE LUCRO (REAL-TIME)' => '',
                'Fórmula de Lucro' => 'Lucro = Valor Líquido - Custo Total - Valor Frete',
                'Valor Líquido' => 'Valor creditado pelo ML (Preço Venda - Tarifas ML de 12~19% - Taxas de Pagamento).',
                'Custo Total' => 'Soma dos custos médios de cada item do pedido (vindo do Master Data de Produtos).',
                'Valor Frete' => 'Custo real cobrado do vendedor, obtido via API /shipments/{id}/costs (campo senders.cost).',
                'Imposto' => 'Calculado dinamicamente (ex: 4% ou 10%) sobre o valor dos produtos, usando a Alíquota Simples da Empresa.',
                'Margem Lucro %' => '(Lucro / Valor Líquido) * 100. Monitoramento de rentabilidade real por venda.',
